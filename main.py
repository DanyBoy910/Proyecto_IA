...
from config import DATASET_PATH, GAP_HOURS, VAR_COLS
...
def train_pipeline():
    ...
    df_filtered, feature_cols, target_cols = load_and_preprocess_data(DATASET_PATH)
    ...
    print(f"   ✓ Creados {len(cv_folds)} folds con gap de {GAP_HOURS} horas")
    ...
    # 7. Guardar modelo
    save_model(final_model, scaler_X_final, scaler_y_final, feature_cols, VAR_COLS)
